...
public static class Kernelˉmemoryˉcontract
{
    ...
    public const string TARGET_NAME = "x86-64-kernel-memory-v9";
    ...
    public const ulong ARENA_PAGES = 182;
    ...
    public const ulong STATE_MAGIC = 0x3930_4D45_4D4B_5657;
    public const uint STATE_VERSION = 9;
}
