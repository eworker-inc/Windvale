...
public static class Firmwareˉprobe
{
    ...
    public const string DIRECTORY_PROCESS_MARKER = "directory-process=isolated\n";
    public const string DISPATCHER_MARKER = "dispatcher=ready-wait\n";
    public const string ENDPOINT_MARKER = "service-endpoints=2\n";
