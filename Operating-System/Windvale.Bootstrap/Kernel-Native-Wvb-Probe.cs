...
public static class Kernelˉnativeˉprobeˉcontract
{
    ...
    public const string TARGET_NAME = "x86-64-kernel-native-wvb-probe-v6";
...
public static class Kernelˉnativeˉprobe
{
    ...
    private static ImmutableArray<byte> Buildˉbridgeˉobject()
    {
        ...
        Output.Emit(0x48, 0x83, 0xEC, 0x58);
        ...
        Output.Emit(0x48, 0x89, 0x44, 0x24, 0x38);
        Output.Emit(0x48, 0x89, 0x44, 0x24, 0x40);
        ...
        Output.Emit(0x48, 0x83, 0xC4, 0x58);
    ...
    private static void Verifyˉbridge(ImmutableArray<byte> objectˉbytes)
    {
        ...
        [
            0x48, 0x83, 0xEC, 0x58, 0x48, 0x89, 0x0C, 0x24,
            0x48, 0xB8, 0x03, 0x00, 0x00, 0x00, 0x48, 0x00, 0x00, 0x00,
            ...
            0x48, 0x8B, 0x0C, 0x24, 0x48, 0x83, 0xC4, 0x58,
            0xE9, 0x00, 0x00, 0x00, 0x00,
            0x48, 0x83, 0xC4, 0x58, 0xB8, 0x01, 0x00, 0x00, 0x00, 0xC3,
        ];
