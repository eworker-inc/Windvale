...
public static class Kernelˉpagingˉcontract
{
    ...
    public const string TARGET_NAME = "x86-64-kernel-paging-v3";
    ...
    public const ulong EXECUTABLE_BYTES = 256 * 1024;
    ...
    public const ulong RECORD_MAGIC = 0x3330_4741_504B_5657;
