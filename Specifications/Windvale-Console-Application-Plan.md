...
The [portable construction recipe](Windvale-Console-Application-Construction.md) now consumes this plan and determines every final byte through exact literal/native spans and implicit zeros. C# remains the recovery construction oracle and independent untrusted-executable verifier. Moving PE/ELF structural verification into portable Windvale is the next gate and must preserve exact rejection behavior.
