...
The Windvale-written compiler and current native WVB runner implement the scalar source and canonical WVB surface below, including `i64`, `u64`, `i8`, `i16`, `u16`, `rune`, `f32`, `f64`, the admitted edition-1 `unit` and `never` checkpoint, edition-1 named variant construction and destructuring through WVB 1.16, and contextual immutable fixed-array construction/access through WVB 1.17. The retained Stage 0 recovery compiler remains a WVB 1.11 differential boundary and does not define the fixed-integer, rune, floating-point, unit, never, multi-field variant, or fixed-array extensions. Direct native array lowering, browser packaging, WebAssembly distribution, and Windvale OS consumers remain explicit narrower subsets until their separately verified contracts advance.
...
The Windvale-written compiler implements constants of every admitted scalar width. It lowers `i64` and `u64` constants to canonical WVB 1.11, `i8`, `i16`, and `u16` constants to the WVB 1.12 fixed-integer family, rune constants to WVB 1.13, the guaranteed floating literal forms to WVB 1.14, edition-1 unit or never evidence to WVB 1.15, edition-1 multi-field variant metadata or named field extraction to WVB 1.16, and fixed-array metadata, construction, and checked access to WVB 1.17, rejecting checked overflow, underflow, a non-scalar, or an invalid exact array type before publication. The retained Stage 0 recovery compiler covers only its frozen WVB 1.11 surface.
