...
This portable, capability-free dependency rule is the current Seed implementation boundary, not the durable application-library policy. [Decision 0139](../Documents/Decisions/0139-Per-Module-Platform-Scope-And-Filesystem-Capabilities.md) accepts per-part platform scope and capability-bearing static libraries as later architecture. A future source/module decision must specify their syntax, transitive approval, canonical lowering, and validation before this section changes behavior.
