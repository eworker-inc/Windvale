...
Kernel native seam version 16, WVA seam version 7, admission bridge version 1, and retained bridge 10 are cross-host qualified at exact commit `860c69c`. Version 15 adds Decision 0088's kernel-owned paging to the pre-paging baseline. Version 16 retains that path, advances fragment metadata to ABI 16 through Decision 0089, and adds Decision 0090's Windvale-owned WVB admission profile. The retained probe uses at most four parameters, so its WVO and bridge bytes remain unchanged across ABI 15 and 16. [Decision 0081](../Documents/Decisions/0081-First-Terminal-X64-Cpu-Exception-Boundary.md) owns historical version 12; [Decisions 0085](../Documents/Decisions/0085-First-Wva-Owned-Q35-Clean-Shutdown.md), [0086](../Documents/Decisions/0086-First-Wva-Owned-Normalized-X64-Trap-Entries.md), and [0087](../Documents/Decisions/0087-Native-Windows-And-Linux-File-Output.md) own the qualified versions 13 and 14 plus bridge 10; [Decision 0088](../Documents/Decisions/0088-First-Kernel-Owned-X64-Page-Tables.md) owns version 15; [Decision 0089](../Documents/Decisions/0089-Bounded-Native-Stack-Arguments.md) owns ABI 16; and [Decision 0090](../Documents/Decisions/0090-First-In-Guest-Wvb-Admission.md) owns version 16. [Decision 0056](../Documents/Decisions/0056-Windvale-Owned-Post-Memory-Evidence.md) records the qualified version-2 bidirectional WVA/WV boundary.
