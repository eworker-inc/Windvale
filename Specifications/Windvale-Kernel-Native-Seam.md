...
Kernel native seam version 17, WVA seam version 8, admission bridge version 2, retained bridge 10, paging version 3, and interpreter profile number 4 are active in implemented probe 30. The composition advances memory to version 7, protected processes to version 9, resource records to version 4, and retains the OS-private `WVBR002` directory. [Decisions 0099](../Documents/Decisions/0099-Bounded-Native-Frame-Admission.md) and [0100](../Documents/Decisions/0100-First-Reclaimed-And-Reused-Process-Root.md) own the new boundaries; Probe 29 remains the qualified baseline.
...
Implemented probe 30 advances to ABI 17, memory 7, protected processes 9, and resource records 4. Its normal process-machine WVO is 155,893 bytes with SHA-256 `4f126af968669458c499e8e40b375cbbd614b2e3e8bb29f1ee46597fc19e21ea`; its fault form is 155,973 bytes with SHA-256 `821d4c1dba668566f9a42f839da14ea78814ac688cb16cbac649bd5bdfbeb6dc`. All 25 focused OS tests pass on Windows, and all four pinned-QEMU scenarios emit `process-reuse=pass`; complete cross-host qualification remains pending.
