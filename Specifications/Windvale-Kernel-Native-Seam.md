...
Firmware probe version 8 links seven WVO objects and produces a deterministic 10,240-byte EFI application with SHA-256 `61cd90eac963ed96d1fdd86d447cb7f2cdeffa50a3de2f5306239de27c1be6b0`. Exact candidate `2fcf531` passes all 15 OS tests and a real pinned QEMU/OVMF boot; the gated transcript adds `native-context=pass`. The shared backend and service thunk pass complete Windows/Debian qualification at the same candidate.
