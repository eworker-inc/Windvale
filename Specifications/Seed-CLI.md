...
```text
windvale compile <source.wv> [--module <dependency.wv>]... [--target <wvb|windows-x64-console-v1|linux-x64-console-v1|windows-x64-console-v2|linux-x64-console-v2|windows-x64-console-v3|linux-x64-console-v3|windows-x64-verifier-v1|linux-x64-verifier-v1|windows-x64-wvb-inspector-v1|linux-x64-wvb-inspector-v1|windows-x64-wvb-runner-v1|linux-x64-wvb-runner-v1|windows-x64-build-driver-v1|linux-x64-build-driver-v1|windows-x64-wva-assembler-v1|linux-x64-wva-assembler-v1>] [-o <artifact>]
...
- Targets `windows-x64-wvb-runner-v1` and `linux-x64-wvb-runner-v1` accept only the fixed read-only WVB execution profile in that contract: one exported `Main() -> i32`, the same five capabilities, and the exact eight services required by `Windvale-Wvb-Runner.wvproj`. The fixed application bundle retains the qualified startup-internal UTF-8 leaf as its ninth service. The runner verifies and interprets the admitted portable `Main() -> i32` subset in Windvale source and defaults to `.exe` and `.elf`. Its exact paired applications and digest-checking launchers are pinned as candidate front-door inputs; ordinary cutover remains pending exact-commit dual-host execution qualification.
