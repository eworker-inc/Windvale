...
- Status: Implemented locally through experimental profile 16 and cross-host qualified through profile 10, but not an accepted permanent target
...
- recursion, function values, indirect calls, `break`, `continue`, arbitrary or unbounded instruction streams, executable records or enums, reclaiming allocation, collection, or browser capability imports;
