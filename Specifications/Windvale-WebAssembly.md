...
The exact portable compiler completes preflight under these bounds. The earlier WVB baseline returned normal `WVXO 2` status `3011` through a 100,000-instruction guest budget. After the WVB 1.11 compiler and the root-first SHA composition evolved, typed record tracing and a measured 768-cell record arena restore complete compilation: the current 919,577-byte compiler with SHA-256 `2bf84dc2a8cbb80c52ec7fb6cb2e29eef27def1707f398a276c61063d73df06e` running in the 816,339-byte interpreter Wasm with SHA-256 `fa819b439f8590bed96dba0dce2c1d79e4d5d41a9a3765dc5b6c37d54f601504` compiles the pinned 100-byte source in 1,183,292 guest and 1,513,529,072 outer instructions. Its canonical `WVCO 1` kind-zero payload is byte-identical to the 183-byte Stage 0 WVB oracle.
