...
- recursion, function values, indirect calls, `break`, `continue`, arbitrary or unbounded instruction streams, byte hashing, executable records or enums, reclaiming allocation, collection, or browser capability imports;
