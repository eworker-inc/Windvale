...
The bootstrap builder embeds `Operating-System/Kernel/Hello-World.wv` and `X64-Main-Shim.wva` as deterministic source inputs. The reference compiler runs the ordinary frontend and typed semantic WIR pipeline, then emits and independently verifies a native kernel WVO. The reference/recovery assembler emits and independently verifies the WVA shim. The builder also creates loader, kernel-memory, and OS byte-adapter WVO objects. The loader imports `Windvale_kernel_entry`; the generated object exports entry and Main while importing memory entry and the byte writer; the memory object exports memory entry and page allocation while importing the WVA shim and writer; the shim exports its entry and imports Main; the adapter exports the writer. The existing linker resolves 76 `relative-i32` call or tail-jump relocations, independently reconstructs the base-zero image, and passes that verified all-code result to UEFI application writer version 2. No generated WVO, EFI application, FAT view, variable store, firmware image, or captured memory map is committed.
...
The canonical compiler object is 1,574 bytes with SHA-256 `05c04cf7e7167850d954ca36d135e68065478301c20819ad27d0d2f10ce51133`. The 158-byte WVA shim has SHA-256 `f7525da5e8365b75adc68bd2174ad5763ed05b774d861c2a0cd6aad6c0e8e1b7`. The canonical probe application is 7,168 bytes with SHA-256 `b4f557fdd39d44858ce05fd6a99b0128a791053a5d3c2aa9e68dc5b5c34a3808`.
...
probe-version=6
efi-bytes=7168
efi-sha256=b4f557fdd39d44858ce05fd6a99b0128a791053a5d3c2aa9e68dc5b5c34a3808
