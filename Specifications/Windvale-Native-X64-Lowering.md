...
446,292-byte WVB at SHA-256
`cd7f69d18d8a2bb34bb7e1db9577fcda6702c507af3cc77e34ed549c4cfb3a44`.
The same native segmented path reconstructs its 6,357,504-byte Windows and
6,356,992-byte Linux applications exactly after rebuilding and repinning the
