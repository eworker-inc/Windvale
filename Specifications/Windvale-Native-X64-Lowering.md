...
including checked `u64`, nested immutable records, and the ABI-23
`storage.random_access_v1` call now builds as a 457,219-byte WVB at SHA-256
`d5b17c84889dab959bd992083a06325149f746d2ff611445df1fb7f0102680b4`.
The same native segmented path reconstructs its 6,499,840-byte Windows and
