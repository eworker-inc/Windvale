...
Ordered consumers now source-own the first 19,526 process-machine bytes and 108
...
before reclamation. The focused owner executes thirty-nine projects and 234
cases with local results 50 through 88.

The module is a migration primitive. Coordinator relocation and channel/
endpoint initialization are separate consumers. Memory release and generation-2 construction,
