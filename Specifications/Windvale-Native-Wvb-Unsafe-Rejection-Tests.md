...
| --- | --- | --- | --- |
| `unknown-opcode` | absolute byte 121, `i32.const` (`0x01`) to `0xFF` | `semantic/structure` | `f84528a577647a8d9c988f2cf082ea642dc7b8f61220bb5d23d57e8d3238c0aa` |
| `truncated-operand` | final byte 136, `return` to operand-bearing `i32.const` | `semantic/structure` | `eac2a31112958af23f89941be6e9591e870438439ea037e2b12a6c23216f74d9` |
| `local-index` | `local.store` operand at bytes 127–130, zero to 999 | `semantic/code-exports` | `857f94ae40c95dd2f2e3f27ba07892c0ae351f1875fc16c91695e5a3872f56a3` |
| `jump-target` | code becomes `jump 999; i32.const 0; i32.const 0; return` | `semantic/code-exports` | `b56e962d4e4d24d6366354e1f4798c4352de236dcad421829d4b8714db3eb2a3` |
...
| --- | ---: | --- | --- | --- |
| `record-parameter-type` | 223 | helper parameter record index `0` to missing index `1` | `semantic/functions` | `8e89cf9b526e1ea93d81d62425f95986daff4469dc7f113f5e38b580ccf163aa` |
...
| `duplicate-record-field` | 191 | second field name `Rght` to duplicate `Left` | `semantic/types` | `73867dcf74f30f4b9237091aa59ea981200f4139636b67eb730bdb71752571b6` |
...
| `duplicate-nominal-name` | 211 | enum name `Secon` to duplicate record name `First` | `semantic/types` | `60d12d56015678f3197a1413cfb058bff64188a8e2256d09f504280fad805f9c` |
...
| `invalid-enum-member` | 202 | member byte 118, `1` to missing `2` | `semantic/code-exports` | `ddd000954aeb8d0c02775128ae52615d9bf4237bda9741eb39e6f9efb4f2ddbe` |
| `enum-const-on-record` | 225 | nominal byte 114, enum `1` to record `0` | `semantic/code-exports` | `3d09445c44bf2d1e3f5b811f254e0bccc902366ad242ea4cf101fc44f23b99d8` |
| `duplicate-enum-value` | 192 | second value byte 188, `1` to duplicate `0` | `semantic/types` | `da453ca0cbe661ab695e21ce8f2ee2530a303ad996bbedfe6f0ae5e9bbb0a00c` |
...
| `wrong-nominal-kind` | 197 | parameter-shape byte 88, enum `8` to record `7` | `semantic/functions` | `da375377c69ca8c87fe17f34460617330fdcc1763e1a465de4805e1ead98cc93` |
...
The semantic reports identify the exact failed substep and end with LF:

- `step=structure` has SHA-256
  `3c619f27145a7ce7dff62b303e739ac145df640662b6f58666ebafebdf267a79`;
- `step=types` has SHA-256
  `3e3e68daeb03b21644951817cf4a256ec0c958e3add6f84725bca7c38461047a`;
- `step=functions` has SHA-256
  `54662bfb7b2473a8608601b5cdd3e5576e6452d0e3a6e06b567b95c304047752`;
- `step=code-exports` has SHA-256
  `6db319329296181174ae9e22df7be3b0be781ff3f98e4a81cf8cb532f8aec96b`.
