...
This implementation currently owns its complete encoder and WVO writer. Decision
0801 accepts later demand-driven extraction of reusable target encoding and
object construction without making the compiler call this WVA parser. Until a
selected instruction family migrates with byte-identical evidence, this file
remains the implemented WVA behavior rather than an aspirational shared layer.
