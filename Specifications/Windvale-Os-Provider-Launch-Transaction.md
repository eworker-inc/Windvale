...
reference `65538`, the exact 195,657-byte image, 48 RX image pages, 16 private
RW/NX pages, one process, and one endpoint under a 64-page ceiling. The network
profile admits process reference `65541`, domain and endpoint reference `65539`,
