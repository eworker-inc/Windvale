...
WVLB 1.2 and specialized WVIR 1.10 reserve one zero placeholder at the source declaration's
...
WVIR 1.10. It checks the exact two-instance count before publishing its artifact
...
publishes specialized WVLB 1.2/WVIR 1.10, so its retained catalog and appended body
are intentionally not byte-identical to a monomorphic WVLB 1.1/WVIR 1.9 oracle.
