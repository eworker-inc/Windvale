...
The first accepted consumer is the complete 12-module Windvale compiler source closure. Building its current project must reproduce the 859,555-byte candidate WVB with SHA-256 `c08f76e998e0280b7c2e3e801a9752f000825c874abeb86e88420c31444d63f9`. This proves deterministic project input selection. The earlier 599,868-byte identity remains the retained cross-host qualification artifact, while the current candidate awaits coherent-batch and dual-host qualification. The separate Windvale-written project parser does not make project syntax part of the compiler, move host path resolution into portable code, or change the Stage 1 to Stage 2 bootstrap contract.
