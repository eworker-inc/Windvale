...
The current module imports `Foundationˉbyteˉordering` through its required alias for canonical section and symbol name comparison. Its locally verified composed WVB is 29,863 bytes with SHA-256 `de2a75116fe734feb3b6bd9758e22211f60e42dbb641d19775144ea7b140e511`; the earlier artifact is cross-host qualified at `4fdea22`. The representative WVO bytes remain unchanged.
