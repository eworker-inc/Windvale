...
`Linker/Windvale/Console-Application-Construction-Core.wv` is portable. Its minimal hosted bridge reads only the named request and returns the recipe. The Stage 0 linker embeds the exact verified 29,322-byte bridge WVB at SHA-256 `4729dd849c72aaa4250d7d54024e8820f827fd08588fa7ba9e5493ab4b8a5d8d`, authorizes only `file.read_bytes`, and applies a five-million-instruction limit.
