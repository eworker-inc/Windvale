...
Moving sparse materialization and untrusted PE/ELF verification into portable Windvale remains a later gate. Until then, C# is still required to turn the recipe into a host byte array and to qualify arbitrary executable input.
