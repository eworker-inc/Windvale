...
The [project-WVB checkpoint](Windvale-Project-Wvb-Checkpoint.md) owns the shared
key, record, limits, validation and standalone launcher behavior.

### OS x64 development batch
