...
`Tests/Native/Retirement-Suite.txt` is 6,365 LF-only bytes with SHA-256
`6f5d907f84c468390050065254a01ee2272e270510cf707b9ce3502437eb509b`.
...
| `database-storage` | `Test-Database-Storage` | 19 | `native database storage status=Passed cases=19 local-results=0 cross-host-images=Verified` |
...
Suites: 62, Passed: 62, Failed: 0, Cases: 3457
```
