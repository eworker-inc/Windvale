...
| Native compiler and host programs | 🚧 In progress | ABI 14/context 6 has qualified native leaves for all 11 service slots plus two Windvale-assembled process-input stencils on Windows and Linux | Move bounded validation, patching, and publication ownership into Windvale |
...
**Current focus:** move bounded object/stencil validation and typed patch application into Windvale, then expand W^X publication, arenas, and execution ownership. C# remains the independent Stage 0/reference/recovery implementation.
