...
| Native compiler and host programs | 🚧 In progress | ABI 11/context 3 and all six deterministic pure native services are cross-host qualified | Narrow hosted adapters and move construction, verification, publication, and execution ownership into Windvale |
...
**Current focus:** move from qualified pure native services toward narrow hosted adapters and greater Windvale ownership of service construction, verification, W^X publication, arenas, and execution while retaining the independent .NET reference/recovery implementation through the retirement gate.
