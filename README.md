...
**Current focus:** extend the qualified first Windvale-assembled native stencil only through a measured multi-patch case, then move bounded validation, W^X publication, arenas, and execution into Windvale while retaining C# as the independent Stage 0/reference/recovery implementation.
