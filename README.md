...
**Current focus:** move bounded service construction, verification, W^X publication, arenas, and execution into Windvale while retaining C# as the independent Stage 0/reference/recovery implementation.
