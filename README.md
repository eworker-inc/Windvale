...
| Windvale operating system | 🚧 In progress | Qualified probe 17 owns vector 6; candidate probe 20 composes WVA-normalized vectors 6/13 and clean Q35 poweroff with ABI 15/context 7 | Cross-host qualify probe 20, then own page tables and add in-guest verification/runtime |
...
**Shared native WVB in the OS:** [`Hello-World.wv`](Operating-System/Kernel/Hello-World.wv) still supplies the special system-profile diagnostics, while ordinary portable [`Native-Wvb-Probe.wv`](Operating-System/Kernel/Native-Wvb-Probe.wv) compiles to canonical verified WVB and then to the shared native path. The currently qualified probe 17 uses bridge 9 and ABI 14/context 6. Candidate probe 19 adds WVA-owned Q35 poweroff and normalized vector-6/vector-13 entries; composed probe 20 uses bridge 10 and ABI 15/context 7, adding a zero file-output-table field because its module remains service-free while preserving those WVA mechanics. After the loader exits UEFI boot services, claims and clears a 64 KiB arena, exercises its allocator, copies the handoff, and switches to an 8 KiB kernel stack, the portable module loops over immutable i32 data, passes borrowed bytes into an internal function, slices and reads them, checks `u8`/`u32` results, and must return exact result 29 before boot continues. This is host-built AOT evidence; the guest does not yet load or verify WVB. Version 17 is the qualified normal transcript:
...
Candidate probe 19 retains the WVA-authored Q35 shutdown function and moves the first reusable exception-entry mechanics into WVA. Vector 6 pushes a synthetic error code; vector 13 preserves the CPU error code; both reach one 40-byte normalized ring-0 frame and terminal handler. Three exact 20,992-byte images pass local focused tests and real pinned QEMU: normal SHA-256 `4f3566379fd55aa1707ac6182c5ec0dee176b35b5e17f8b74687374eb995de0f` exits cleanly with code 0, invalid opcode SHA-256 `23ff09ee1d7b0fb20d770edbb76a7acb0bfc3b7a9b3c88571644092dc88ca9f2` reports `(6, 0)`, and general protection SHA-256 `75b48804f0803a5c747158ed77a71942237d376af48d0276933c69c44ef60562` reports `(13, 0)`; both faults terminate with host code 3. Cross-host qualification is pending. This is still terminal ring-0 evidence, not recovery, page faults, interrupts, or a general dispatcher.

Probe 20 composes Decision 0087's ABI-only rebuild with probe 19's three WVA paths. It retains the 40-byte normalized ring-0 frame, clean Q35 poweroff, and scenario-specific terminal behavior while supplying the service-free guest bridge with a zero file-output-table pointer. Its three 20,992-byte images pass local focused tests and pinned QEMU: normal SHA-256 `d4a9e3625779dd3ef2a03fd71ecfe1502c1ad39378da7adbcf7e4b55636eed8c` exits 0, invalid-opcode SHA-256 `705670b1054589b80e3c918c03e9f751304e3f4b5bda77485f606433db68a757` exits 3 with `(6, 0)`, and general-protection SHA-256 `df45d8e0f69581e5ed3b46608598e6170413f80c5c1bbba9233e9842cdd7a04d` exits 3 with `(13, 0)`. The committed archive still must complete Windows and Debian qualification. This is terminal ring-0 evidence, not recovery, page faults, interrupts, or a general dispatcher.

The exact ownership, allocator, implementation seam, target, and evidence limits are recorded in [Decision 0052](Documents/Decisions/0052-First-Kernel-Owned-Memory-Foundation.md), [Decision 0056](Documents/Decisions/0056-Windvale-Owned-Post-Memory-Evidence.md), [Decision 0064](Documents/Decisions/0064-First-Shared-Native-Wvb-In-Windvale-Os.md), [Decision 0065](Documents/Decisions/0065-Versioned-Native-Execution-Context-And-Console-Service.md), [Decision 0066](Documents/Decisions/0066-Borrowed-Bytes-And-Unsigned-Native-Values.md), [Decision 0067](Documents/Decisions/0067-Borrowed-Hosted-Input-And-First-Native-Wvb-Inspector.md), [Decision 0068](Documents/Decisions/0068-Bounded-Native-Nominal-Values-And-Wvdump-Structural-Core.md), [Decision 0069](Documents/Decisions/0069-Dynamic-Native-Text-And-Complete-Wvdump.md), [Decision 0070](Documents/Decisions/0070-First-Runtime-Native-Utf8-Service.md), [Decision 0071](Documents/Decisions/0071-Native-Text-Arena-And-Core-Text-Services.md), [Decision 0072](Documents/Decisions/0072-Final-Pure-Runtime-Native-Services.md), [Decision 0073](Documents/Decisions/0073-Native-Argument-Table-And-Process-Input-Services.md), [Decision 0074](Documents/Decisions/0074-Native-Windows-And-Linux-Output-Services.md), [Decision 0076](Documents/Decisions/0076-Native-Windows-And-Linux-File-Input.md), [Decision 0077](Documents/Decisions/0077-First-Windvale-Owned-Native-Stencil.md), [Decision 0078](Documents/Decisions/0078-Multi-Patch-Windvale-Native-Stencil.md), [Decision 0079](Documents/Decisions/0079-First-Windvale-Native-Stencil-Consumer.md), [Decision 0080](Documents/Decisions/0080-Native-Byte-Result-And-Live-Stencil-Consumption.md), [Decision 0081](Documents/Decisions/0081-First-Terminal-X64-Cpu-Exception-Boundary.md), [Decision 0082](Documents/Decisions/0082-Windvale-Owned-Native-Publication-Layout.md), [Decision 0083](Documents/Decisions/0083-Windvale-Owned-Native-Publication-Lifetime.md), and candidate [Decisions 0085](Documents/Decisions/0085-First-Wva-Owned-Q35-Clean-Shutdown.md), [0086](Documents/Decisions/0086-First-Wva-Owned-Normalized-X64-Trap-Entries.md), and [0087](Documents/Decisions/0087-Native-Windows-And-Linux-File-Output.md), the [native execution-context specification](Specifications/Windvale-Native-Execution-Context.md), the [native file-output specification](Specifications/Windvale-Native-File-Output.md), the [native publication-plan specification](Specifications/Windvale-Native-Publication-Plan.md), the [publication-lifetime specification](Specifications/Windvale-Native-Publication-Lifetime.md), the [WVA stencil specification](Specifications/Wva-Native-Stencil.md), the [kernel-memory specification](Specifications/Windvale-Kernel-Memory.md), the [kernel trap-frame specification](Specifications/Windvale-Kernel-Trap-Frame.md), the [kernel CPU-exception specification](Specifications/Windvale-Kernel-Exceptions.md), the [kernel-shutdown specification](Specifications/Windvale-Kernel-Shutdown.md), and the [kernel native-seam specification](Specifications/Windvale-Kernel-Native-Seam.md).

**Current focus:** qualify Decision 0087's bounded native Windows/Linux `file.write_bytes` path together with probe 20's composed Decisions 0085 and 0086 evidence, then admit the next exact compiler blocker: record-shaped parameters or locals in `Compilerˉbodyˉblockˉstepˉvalid` (`WVN2002`). File output is no longer the blocker in the exact 599,868-byte compiler WVB. Decision 0083 remains the latest qualified native ownership transfer; raw Windows/Linux memory authority plus OS descriptor publication, terminal policy, packaging, and linking remain inside narrow C# Stage 0 adapters and are not claimed as Windvale-native yet.

**Latest qualified evidence:** exact commit `a898fe8` passes zero-warning Windows and Debian Qualification with all 64 Seed tests and the complete CLI/reproduction gate. Windvale owns every executable-image extent, canonical service placement, and allowed allocate/copy/seal/invoke/release transition; one internal C# owner retains raw Windows/Linux memory authority. Normalized contracts and all 69 portable artifacts (7,846,538 bytes) match byte for byte; both hosts pass all 17 OS tests. Pinned QEMU retains both exact probe-17 images: the ordinary success path returns host code 1, and the explicit invalid-opcode path emits its complete terminal panic suffix and returns expected host code 3. C# remains the native WVB loader/compiler/verifier, platform memory and arena authority, invocation adapter, and independent recovery implementation. See [Decision 0083](Documents/Decisions/0083-Windvale-Owned-Native-Publication-Lifetime.md), the [qualification evidence](Documents/Project/Seed-Verification-Evidence.md), and the [development roadmap](Documents/Project/Roadmap.md) for the complete scope.
