...
| Windvale operating system | 🚧 In progress | Qualified probe 28 cleans one borrow; candidate probe 29 atomically grants, looks up, budgets, and cleans a typed WVB/resource pair | Cross-host qualify probe 29, then let reuse, broader input, independent lifetime, or a third runnable determine the next boundary |
