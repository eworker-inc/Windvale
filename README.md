...
| Native compiler and host programs | 🚧 In progress | ABI 11/context 3 cross-host qualifies one arena shared by managed/native services plus exact UTF-8, concatenation, and integer-format leaves | Migrate enum naming and quoting, then narrow hosted native adapters |
