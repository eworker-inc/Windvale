...
- An in-progress Windvale-written linker core that validates WVO, resolves symbols, lays out sections, constructs immutable flat images, and applies checked relocations in verified bytecode
