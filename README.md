...
- A Windvale-written WVIR-to-WVB backend with canonical function/data/type/capability ordering, all three profiles, primitive static data, immutable records, nominal enums, explicit capabilities, text/bytes and Foundation intrinsics, exact Stage 0 byte equality, mandatory verification, and runtime execution
