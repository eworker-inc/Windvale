...
| Windvale operating system | 🚧 In progress | Probe 26 is cross-host qualified and supplies `boot:main.wvb` to the CPL3 Windvale interpreter through a separate RO/NX page and an exact ABI-16 service leaf | Move resource ownership toward init/package service, broaden a measured module, or measure scheduling pressure |
