...
| Windvale operating system | 🚧 In progress | The pre-paging probe-20 baseline is qualified; current candidates own the first W^X page-table root and admit one embedded WVB through AOT Windvale code before its native form executes | Cross-host qualify both candidates, then add one protected process/thread/capability/IPC boundary |
