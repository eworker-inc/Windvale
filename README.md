...
**Current focus:** design native instruction budgeting and safe points, then admit backward branches and loops before shared-ABI calls and static data.
