...
internal static partial class Program
{
    private static void Nativeˉwvˉlinkerˉfrontˉdoorˉruns()
    {
        ...
        Equal("windvale-native-wv-linker-candidate-2", Root.GetProperty("format").GetString());
        ...
        Equal("0501", Root.GetProperty("constructionDecision").GetString());
        Equal("pending", Root.GetProperty("qualification").GetString());
        Equal(
            "windvale-native-independent-segmented-reconstruction",
