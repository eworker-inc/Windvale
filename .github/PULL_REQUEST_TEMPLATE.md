...
Describe the problem, the intended result, and why this scope is appropriate.

## Contracts and risk

Identify affected specifications, decisions, profiles, formats, capabilities, security boundaries, or compatibility expectations. Write “none” when the change does not affect them.

## Verification

List the exact checks run and their results. State which broader checks were not run and why.
