...
call :run_case "unknown-opcode" "Tests\Native\Wvb-Unsafe-Rejections\Unknown-Opcode.wvb.b64" "f84528a577647a8d9c988f2cf082ea642dc7b8f61220bb5d23d57e8d3238c0aa" "3c619f27145a7ce7dff62b303e739ac145df640662b6f58666ebafebdf267a79"
if errorlevel 1 goto :failed
call :run_case "truncated-operand" "Tests\Native\Wvb-Unsafe-Rejections\Truncated-Operand.wvb.b64" "eac2a31112958af23f89941be6e9591e870438439ea037e2b12a6c23216f74d9" "3c619f27145a7ce7dff62b303e739ac145df640662b6f58666ebafebdf267a79"
if errorlevel 1 goto :failed
call :run_case "local-index" "Tests\Native\Wvb-Unsafe-Rejections\Local-Index.wvb.b64" "857f94ae40c95dd2f2e3f27ba07892c0ae351f1875fc16c91695e5a3872f56a3" "6db319329296181174ae9e22df7be3b0be781ff3f98e4a81cf8cb532f8aec96b"
if errorlevel 1 goto :failed
call :run_case "jump-target" "Tests\Native\Wvb-Unsafe-Rejections\Jump-Target.wvb.b64" "b56e962d4e4d24d6366354e1f4798c4352de236dcad421829d4b8714db3eb2a3" "6db319329296181174ae9e22df7be3b0be781ff3f98e4a81cf8cb532f8aec96b"
if errorlevel 1 goto :failed
...
if errorlevel 1 goto :failed
call :run_case "record-parameter-type" "Tests\Native\Wvb-Unsafe-Rejections\Record-Parameter-Type.wvb.b64" "8e89cf9b526e1ea93d81d62425f95986daff4469dc7f113f5e38b580ccf163aa" "54662bfb7b2473a8608601b5cdd3e5576e6452d0e3a6e06b567b95c304047752"
if errorlevel 1 goto :failed
...
if errorlevel 1 goto :failed
call :run_case "duplicate-record-field" "Tests\Native\Wvb-Unsafe-Rejections\Duplicate-Record-Field.wvb.b64" "73867dcf74f30f4b9237091aa59ea981200f4139636b67eb730bdb71752571b6" "3e3e68daeb03b21644951817cf4a256ec0c958e3add6f84725bca7c38461047a"
if errorlevel 1 goto :failed
...
if errorlevel 1 goto :failed
call :run_case "duplicate-nominal-name" "Tests\Native\Wvb-Unsafe-Rejections\Duplicate-Nominal-Name.wvb.b64" "60d12d56015678f3197a1413cfb058bff64188a8e2256d09f504280fad805f9c" "3e3e68daeb03b21644951817cf4a256ec0c958e3add6f84725bca7c38461047a"
if errorlevel 1 goto :failed
...
if errorlevel 1 goto :failed
call :run_case "invalid-enum-member" "Tests\Native\Wvb-Unsafe-Rejections\Invalid-Enum-Member.wvb.b64" "ddd000954aeb8d0c02775128ae52615d9bf4237bda9741eb39e6f9efb4f2ddbe" "6db319329296181174ae9e22df7be3b0be781ff3f98e4a81cf8cb532f8aec96b"
if errorlevel 1 goto :failed
call :run_case "enum-const-on-record" "Tests\Native\Wvb-Unsafe-Rejections\Enum-Const-On-Record.wvb.b64" "3d09445c44bf2d1e3f5b811f254e0bccc902366ad242ea4cf101fc44f23b99d8" "6db319329296181174ae9e22df7be3b0be781ff3f98e4a81cf8cb532f8aec96b"
if errorlevel 1 goto :failed
call :run_case "duplicate-enum-value" "Tests\Native\Wvb-Unsafe-Rejections\Duplicate-Enum-Value.wvb.b64" "da453ca0cbe661ab695e21ce8f2ee2530a303ad996bbedfe6f0ae5e9bbb0a00c" "3e3e68daeb03b21644951817cf4a256ec0c958e3add6f84725bca7c38461047a"
if errorlevel 1 goto :failed
...
if errorlevel 1 goto :failed
call :run_case "wrong-nominal-kind" "Tests\Native\Wvb-Unsafe-Rejections\Wrong-Nominal-Kind.wvb.b64" "da375377c69ca8c87fe17f34460617330fdcc1763e1a465de4805e1ead98cc93" "54662bfb7b2473a8608601b5cdd3e5576e6452d0e3a6e06b567b95c304047752"
if errorlevel 1 goto :failed
