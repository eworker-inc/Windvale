...
for %%F in ("%Object%") do if not "%%~zF"=="952002" goto :failure
certutil -hashfile "%Object%" SHA256 | findstr /i /x /c:"5a6feaaf9be084e83b539080a14949809dcd3e3d99fca514a57b6f931af6d263" >nul
if errorlevel 1 goto :failure
