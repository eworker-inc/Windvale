...
for %%F in ("%Object%") do if not "%%~zF"=="512978" goto :failure
certutil -hashfile "%Object%" SHA256 | findstr /i /x /c:"dff07c3f6a52dedf6bcd96181221cba50c831359502ec763ee77f6aaaaafdfaa" >nul
if errorlevel 1 goto :failure
