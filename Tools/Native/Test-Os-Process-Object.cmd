...
for %%F in ("%Object%") do if not "%%~zF"=="951843" goto :failure
certutil -hashfile "%Object%" SHA256 | findstr /i /x /c:"2ea81c1e4e5bbeb2656dd3a938b330f391fd3749b54a6b4f5cafde45af1e74b2" >nul
if errorlevel 1 goto :failure
