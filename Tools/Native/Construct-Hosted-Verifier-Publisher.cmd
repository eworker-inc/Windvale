...
call :verify_file "%HostedToolset%\SHA256SUMS" 6927 23f2bf3e62212d37d2eb07ab95620e9c708181e7d6e899e8dc409d89e72bbe8e "hosted toolset inventory"
...
if errorlevel 1 exit /b 1
if /I "%Role%"=="wvo-publisher" (
    call :verify_file "%RawLowerer%" 7597568 61a0789f80c7a44e828bfc7bede7725c9c7871b6434c6d464a90fe00347cd9e9 "raw native WVB-to-WVO lowerer"
    if errorlevel 1 exit /b 1
)
if /I "%Role%"=="console-application-publisher" (
    call :verify_file "%RawLowerer%" 7597568 61a0789f80c7a44e828bfc7bede7725c9c7871b6434c6d464a90fe00347cd9e9 "raw native WVB-to-WVO lowerer"
