...
findstr /c:"artifact package windvale.wvdb-query 40c09378e20b5ac49d41fada61c24e786363e89bf839925cac8d9f3c715a9378 43598" "%Work%\First\Release-Manifest.txt" >nul || goto :cleanup
findstr /c:"artifact generation linux-x64 d09fa80957b663d3f6d2e85fa8b1ccf7cb3a79c35e250a94d4a6e9f86fec4bd5 726" "%Work%\First\Release-Manifest.txt" >nul || goto :cleanup
findstr /c:"artifact generation windows-x64 7ab98618e589b58850f94a1390c9a2d887f51127c6e6d6cc4c674b319d7a4999 728" "%Work%\First\Release-Manifest.txt" >nul || goto :cleanup
...
node "%GenerationPublisher%" publish "%Work%\Installed" ^
    ...
    7ab98618e589b58850f94a1390c9a2d887f51127c6e6d6cc4c674b319d7a4999 >nul || goto :cleanup
