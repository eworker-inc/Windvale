...
call :verify_file "%LowererWvb%" 457041 15a91a965860c4a36ae114651e87b82e5cd31869f4852040bb428f19f9d0382a "WVB-to-WVO tool WVB"
if errorlevel 1 goto :cleanup
call :verify_file "%WindowsApplication%" 6498816 8e4656c9f478c6aecd58d7e3e5fda2a44d420562a5dc9d359795b15494922a89 "Windows WVB-to-WVO application"
if errorlevel 1 goto :cleanup
call :verify_file "%LinuxApplication%" 6500352 0ea1b8ff4bda963b40bb9fa8d62852530e0fc4945e059be135fc2ee829bfe4ac "Linux WVB-to-WVO application"
if errorlevel 1 goto :cleanup
