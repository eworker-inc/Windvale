...
call :check_file "%Candidate%\Wvb-Runner.wvb" 136020 65cdb8a1ab0776dfb4da2c89a53e53dfa67072ff3e6958adc58c461e82d1a9d6
if errorlevel 1 goto :inventory_failed
call :check_file "%Candidate%\Wvb-Runner.wvo" 1233367 14011cc7879b2b876d5b2cf17db0ecc522a1b47d6a9eaf2e9d3773850a5c7553
if errorlevel 1 goto :inventory_failed
call :check_file "%Candidate%\windows-x64-wvrun.exe" 1248768 b30390b51542648f6e69b2078135f25b77cde18432e72b9137bdf6066e8c2f1d
if errorlevel 1 goto :inventory_failed
call :check_file "%Candidate%\linux-x64-wvrun.elf" 1249280 ab318af04fab63833d569787a0977d7239e0eb53a268e508f25823eb32c212cb
if errorlevel 1 goto :inventory_failed
