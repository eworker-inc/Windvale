...
if (Developmentˉonly) {
    ...
    process.stdout.write(
        `native language 1 foundation borrow development status=Passed cases=${Foundationˉonly ? 179 : Foundationˉplanˉonly ? 16 : Foundationˉdirectoriesˉonly ? 24 : 116} ` +
...
async function Runˉpublicationˉandˉexecution() {
    ...
    process.stdout.write(
        ...
        `cases=${329 + Growˉmalformedˉcases.length +
