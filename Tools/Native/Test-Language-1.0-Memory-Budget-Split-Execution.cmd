...
:usage
    >&2 echo Usage: Tools\Native\Test-Language-1.0-Memory-Budget-Split-Execution.cmd [--foundation-borrow^|--foundation-borrow-plan^|--foundation-borrow-directories^|--foundation-borrow-owners^|--foundation-borrow-components]
    exit /b 64
