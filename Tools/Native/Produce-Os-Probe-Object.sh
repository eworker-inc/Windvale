...
case $1 in
    ...
    paging)
        expected_bytes=1292
        expected_digest=a76c4a199d46f6d91c0d3cd76aec7439a5e3fa72403cfc753fa6c36cd5b9b871
        ;;
    memory)
        expected_bytes=1529
...
if [[ $1 == loader ]]; then
    ...
    producer_digest=20abb93b64bf1f18b98e55aa849b7544040a9b99f34cb700f73946cd65600058
fi
