...
for %%F in ("%Object%") do if not "%%~zF"=="129310" goto :failure
certutil -hashfile "%Object%" SHA256 | findstr /i /x /c:"35d751147a7285fb926ba68e77da4ef554bcf68a58963520153f23ea3e8c4678" >nul
if errorlevel 1 goto :failure
