...
[[ $(wc -c < "$work/Emitter.wvb") -eq 972044 ]] || exit 1
printf '%s  %s\n' \
...
[[ $(wc -c < "$work/Generic-Wir-A.wvb") -eq 1187360 ]] || exit 1
printf '%s  %s\n' \
