...
[[ $(wc -c < "$work/Analyzer.wvb") -eq 1088695 ]] || exit 1
printf '%s  %s\n' \
...
[[ $(wc -c < "$work/Emitter.wvb") -eq 1002147 ]] || exit 1
printf '%s  %s\n' \
