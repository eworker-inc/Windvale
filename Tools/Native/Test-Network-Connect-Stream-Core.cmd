...
:allocate
set "Work=%TemporaryRoot%\windvale-network-connect-stream-%RANDOM%-%RANDOM%-%RANDOM%"
...
echo(%ResolvedWork%| findstr /b /i /c:"%TemporaryRoot%\windvale-network-connect-stream-" >nul || exit /b 1
