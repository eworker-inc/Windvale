...
findstr /b /c:"module version=1.11 profile=hosted name=" "%Work%\Echo.txt" >nul || goto :cleanup
findstr /c:"Windvale" "%Work%\Echo.txt" >nul || goto :cleanup
findstr /b /c:"capability index=0 name=" "%Work%\Echo.txt" >nul || goto :cleanup
