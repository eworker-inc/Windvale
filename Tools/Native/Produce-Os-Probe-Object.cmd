...
for %%F in ("%Producer%") do if not "%%~zF"=="413696" (
    >&2 echo The Windows native OS Probe object producer length is invalid.
    exit /b 1
)
certutil -hashfile "%Producer%" SHA256 | findstr /i /x /c:"895237d4a651b4fb0a8a458a7bfa55f952c0364304d6e2af3f30fdc945ba5889" >nul
if errorlevel 1 (
...
:usage
>&2 echo Usage: Tools\Native\Produce-Os-Probe-Object.cmd ^<exceptions^|wvb-admission-bridge^> ^<output.wvo^>
exit /b 64
