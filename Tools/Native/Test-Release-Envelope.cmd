...
node "%Creator%" generate-key root "%Work%\Root-Key" >nul || goto :cleanup
node "%Creator%" generate-key release "%Work%\Release-Key" >nul || goto :cleanup
node "%Creator%" generate-key root "%Work%\Other-Root-Key" >nul || goto :cleanup
node "%Creator%" generate-key release "%Work%\Other-Release-Key" >nul || goto :cleanup
