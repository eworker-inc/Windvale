...
pwsh -NoLogo -NoProfile -Command "$p='%Work%\Approval-Identity\%Linux%'; $t=[IO.File]::ReadAllText($p); [IO.File]::WriteAllText($p, $t.Replace('0b58e435e08045a7118353e2a454e92f4eadfdf36458693e5dd1cf85b58dfdb2', ('0' * 64)), [Text.UTF8Encoding]::new($false))" || goto :cleanup
