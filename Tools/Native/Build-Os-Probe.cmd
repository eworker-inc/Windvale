...
if errorlevel 1 goto :failure
call "%ObjectProducer%" exceptions "%Work%\09-exceptions.wvo" >"%Work%\09.log" 2>&1
if errorlevel 1 goto :failure
call "%ObjectProducer%" wvb-admission-bridge "%Work%\12-wvb-admission-bridge.wvo" >"%Work%\12.log" 2>&1
if errorlevel 1 goto :failure
