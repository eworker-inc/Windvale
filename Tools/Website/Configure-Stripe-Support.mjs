...
const Supportˉtiers = Object.freeze([
    {
        ...
        amount: 2_000,
        description: "One-time support for the open-source Windvale project at the Spark level.",
    },
    {
        key: "builder",
        name: "Windvale Builder Support",
        amount: 5_000,
        description: "One-time support for the open-source Windvale project at the Builder level.",
    },
    {
        key: "accelerator",
        name: "Windvale Accelerator Support",
        amount: 10_000,
        description: "One-time support for the open-source Windvale project at the Accelerator level.",
    },
    {
        key: "champion",
        name: "Windvale Champion Support",
        amount: 50_000,
        description: "One-time support for the open-source Windvale project at the Champion level.",
    },
    {
        key: "cornerstone",
        name: "Windvale Cornerstone Support",
        amount: 100_000,
        description: "One-time support for the open-source Windvale project at the Cornerstone level.",
    },
    {
        key: "any",
        name: "Choose Your Windvale Support",
        amount: null,
        description: "Choose a one-time amount to support the open-source Windvale project.",
    },
]);
...
function Paymentˉlinkˉparameters(Tier, Priceˉid) {
    return Makeˉparameters([
        ...
        ["custom_text[submit][message]", "Thank you for supporting Windvale's open-source development. Public recognition is always optional."],
