...
Requireˉtext(Playgroundˉapplication, "StandardOutput", "bounded console rendering");
...
Requireˉtext(Worker, "AuthorizeConsoleWriteLine", "worker console grant boundary");
...
Requireˉtext(Core, "STANDARD_OUTPUT_LIMIT", "bounded console output");
