...
if [ "$NATIVE_SERVICE_BUNDLE_MATERIALIZATION_CORE_HASH" != '54a0cb83cba3c9c9118cfc209aaef43938f9f9a9f4212ccb9d4657ce6a139ba1' ]; then
...
if [ "$NATIVE_SERVICE_BUNDLE_MATERIALIZATION_BRIDGE_HASH" != '25512a7c3e6eae0dd060426d5a51a93abfc7a7127f59538fd2a315242ed2b660' ]; then
...
if [ "$NATIVE_SERVICE_BUNDLE_MATERIALIZATION_ARTIFACT_HASH" != '8bb1f06bd8b25d9a5ff78971ad4af36b609c618b080ed0fa9b17fe4b51669629' ] ||
    [ "$(wc -c < "$NATIVE_SERVICE_BUNDLE_MATERIALIZATION_ARTIFACT_RETAINED")" -ne 157174 ]; then
