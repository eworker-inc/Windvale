...
$Cases = @(
    ...
    @{ Name = 'assembler'; Paths = @('Assembler/Windvale.Assembler/Assembly-Compiler.cs'); Scope = 'qualification'; Editor = $false; Areas = @('assembler') },
    @{ Name = 'linker'; Paths = @('Linker/Windvale.Linker/Linker.cs'); Scope = 'qualification'; Editor = $false; Areas = @('linker') },
