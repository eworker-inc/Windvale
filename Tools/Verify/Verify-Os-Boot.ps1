...
try {
    ...
    $Report = [pscustomobject][ordered]@{
        ...
        SerialMarker = switch ($Scenario) {
            'normal' {
                'windvale-os-boot-24-entry-system-table-memory-map-boot-services-exited-memory-owned-allocator-kernel-stack-paging-owned-wvb-admission-processes-isolated-wvb-runtime-interpreted-init-service-pass-ipc-cross-process-hello-cpu-exceptions-armed-native-context-native-wvb-windvale-source-status-pass-shutdown-poweroff'
            }
            'invalid-opcode' {
                'windvale-os-boot-24-entry-system-table-memory-map-boot-services-exited-memory-owned-allocator-kernel-stack-paging-owned-wvb-admission-processes-isolated-wvb-runtime-interpreted-init-service-pass-ipc-cross-process-hello-panic-invalid-opcode-vector-6-error-code-0-status-panic'
            }
            'general-protection' {
                'windvale-os-boot-24-entry-system-table-memory-map-boot-services-exited-memory-owned-allocator-kernel-stack-paging-owned-wvb-admission-processes-isolated-wvb-runtime-interpreted-init-service-pass-ipc-cross-process-hello-panic-general-protection-vector-13-error-code-0-status-panic'
            }
            'user-fault' {
    ...
    if ($PassThru) {
        ...
        Write-Output 'windvale-os-boot-report 24'
