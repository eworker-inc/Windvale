...
$DatabaseDevelopmentContractTargets = @{
    ...
    'Specifications/Windvale-Database-Transaction-Paths.md' = @('transaction-paths', 'transaction-ancestor-groups')
    ...
    'Specifications/Windvale-Database-Transaction-Child-Replacements.md' = @('transaction-branch-partition', 'transaction-parent-groups', 'transaction-branch-pages', 'transaction-ancestor-groups')
    'Specifications/Windvale-Database-Transaction-Branch-Partition.md' = @('transaction-branch-partition', 'transaction-parent-groups', 'transaction-branch-pages', 'transaction-ancestor-groups')
    ...
    'Specifications/Windvale-Database-Transaction-Ancestor-Groups.md' = @('transaction-ancestor-groups')
...
if (!$DatabaseDevelopmentRequiresAllTargets -and
    ...
    $SelectedDatabaseDevelopmentTargets.Count -eq 9 -and
    ...
    $SelectedDatabaseDevelopmentTargets.Contains('transaction-ancestor-groups')) {
