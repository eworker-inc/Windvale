...
The tree layer now publishes the first depth-two generation and then replaces
or splits a routed leaf while preserving untouched children. Multi-page hosted
...
the old committed page it makes obsolete; reclamation is not yet implemented.
