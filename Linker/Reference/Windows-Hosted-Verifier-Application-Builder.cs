...
internal static class Windowsˉhostedˉverifierˉapplicationˉbuilder
{
        ...
        uint nativeˉentryˉoffset)
    {
        ...
        Result[Optional + 2] = Windowsˉhostedˉverifierˉapplicationˉcontract.FORMAT_VERSION;
        ...
        Writeˉu64(Result, Optional + 24,
            Windowsˉhostedˉverifierˉapplicationˉcontract.IMAGE_BASE);
        ...
        Writeˉu32(Result, Optional + 60,
            checked((uint)Windowsˉhostedˉverifierˉapplicationˉcontract.HEADER_BYTES));
        ...
        Writeˉu32(Result, Optional + 120,
            Layout.Importˉaddress + Windowsˉhostedˉverifierˉimports.DIRECTORY_OFFSET);
        ...
        Writeˉu32(Result, Optional + 208,
            Layout.Importˉaddress + Windowsˉhostedˉverifierˉimports.KERNEL_IAT_OFFSET);
        Writeˉu32(Result, Optional + 212, Windowsˉhostedˉverifierˉimports.IAT_BYTES);
