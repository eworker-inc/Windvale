...
internal static class Linuxˉhostedˉverifierˉapplicationˉverifier
{
            ...
            Hostedˉverifierˉapplicationˉprofile.Compilerˉwvbˉverifier)
    {
        ...
        {
            throw Invalid("The Linux hosted-verifier application has trailing or missing bytes.");
        }
        ...
        Requireˉu64(bytes, 24,
            Linuxˉhostedˉverifierˉapplicationˉcontract.TEXT_ADDRESS, "entry address");
        ...
        Verifyˉprogramˉheader(bytes, Headerˉload, 1, 4, 0, 0,
            Linuxˉhostedˉverifierˉapplicationˉcontract.HEADER_BYTES,
            Linuxˉhostedˉverifierˉapplicationˉcontract.HEADER_BYTES,
        ...
        var Textˉfile = Linuxˉhostedˉverifierˉapplicationˉcontract.HEADER_BYTES;
        ...
        {
            throw Invalid("The Linux hosted-verifier service bundle is noncanonical.");
        }
        Requireˉzero(bytes,
        ...
        string field)
    {
        ...
        {
            throw Invalid($"The Linux hosted-verifier {field} is invalid.");
        }
    }
