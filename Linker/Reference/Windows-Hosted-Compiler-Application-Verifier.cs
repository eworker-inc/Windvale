...
internal static class Windowsˉhostedˉcompilerˉapplicationˉverifier
{
        ...
        Nativeˉserviceˉbundle expectedˉbundle)
    {
        ...
        var Dataˉfile = checked((uint)
            Windowsˉhostedˉcompilerˉapplicationˉcontract.HEADER_BYTES + Textˉfileˉbytes);
        ...
        var Relocationˉfile = checked(Dataˉfile +
            Windowsˉhostedˉcompilerˉapplicationˉcontract.DATA_FILE_BYTES);
        ...
        {
            throw Invalid("The Windows hosted-compiler application has trailing or missing bytes.");
        }
        ...
        Requireˉu32(bytes, OPTIONAL + 12,
            Dataˉvirtual - Windowsˉhostedˉcompilerˉapplicationˉcontract.DATA_FILE_BYTES,
            "uninitialized data size");
        Requireˉu32(bytes, OPTIONAL + 16,
            Windowsˉhostedˉcompilerˉapplicationˉcontract.TEXT_ADDRESS, "entry RVA");
        Requireˉu32(bytes, OPTIONAL + 20,
            Windowsˉhostedˉcompilerˉapplicationˉcontract.TEXT_ADDRESS, "code RVA");
        Requireˉu64(bytes, OPTIONAL + 24,
            Windowsˉhostedˉcompilerˉapplicationˉcontract.IMAGE_BASE, "image base");
        ...
        Requireˉu32(bytes, OPTIONAL + 60,
            Windowsˉhostedˉcompilerˉapplicationˉcontract.HEADER_BYTES, "header size");
        ...
        Verifyˉsection(bytes, SECTIONS, ".text", Textˉvirtual,
            ...
            Textˉfileˉbytes,
            Windowsˉhostedˉcompilerˉapplicationˉcontract.HEADER_BYTES,
            0x6000_0020);
        ...
        var Textˉfile = Windowsˉhostedˉcompilerˉapplicationˉcontract.HEADER_BYTES;
        var Bundleˉfile = Textˉfile +
            Windowsˉhostedˉcompilerˉapplicationˉcontract.BUNDLE_TEXT_OFFSET;
        Requireˉzero(bytes,
            Textˉfile + Windowsˉhostedˉcompilerˉapplicationˉcontract.STARTUP_BYTES,
            Windowsˉhostedˉcompilerˉapplicationˉcontract.BUNDLE_TEXT_OFFSET -
                Windowsˉhostedˉcompilerˉapplicationˉcontract.STARTUP_BYTES,
        ...
        {
            throw Invalid("The Windows hosted-compiler service bundle is noncanonical.");
        }
        Requireˉzero(bytes,
        ...
        Windowsˉhostedˉcompilerˉimports.Verify(
            bytes.Slice(checked((int)Dataˉfile),
                Windowsˉhostedˉcompilerˉimports.PAGE_BYTES),
            Dataˉaddress);
        ...
        {
            throw Invalid("The Windows hosted-compiler bundle metadata is inconsistent.");
        }
        Windowsˉhostedˉcompilerˉstartup.Verify(
        ...
        for (var Index = 0; Index < 16; Index++)
        {
            ...
            if (Index == 1)
            {
                Requireˉu32(bytes, Offset,
                    dataˉaddress + Windowsˉhostedˉcompilerˉimports.DIRECTORY_OFFSET,
            ...
            {
                Requireˉu32(bytes, Offset,
                    dataˉaddress + Windowsˉhostedˉcompilerˉimports.KERNEL_IAT_OFFSET,
                    "IAT directory RVA");
                Requireˉu32(bytes, Offset + 4,
                    Windowsˉhostedˉcompilerˉimports.IAT_BYTES,
                    "IAT directory size");
            }
            else
            {
    ...
    private static void Requireˉname(ReadOnlySpan<byte> bytes, int offset, string expected)
    {
        ...
        {
            throw Invalid($"The Windows hosted-compiler section '{expected}' is invalid.");
        }
    }
        ...
        string field)
    {
        ...
        {
            throw Invalid($"The Windows hosted-compiler {field} is invalid.");
        }
    }
