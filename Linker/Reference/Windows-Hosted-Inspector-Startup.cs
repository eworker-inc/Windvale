...
internal static class Windowsˉhostedˉinspectorˉstartup
{
    ...
    internal const string TEMPLATE_SHA256 =
        "7f9e9f9f7423a69b203309770115e1d62e124ef883c7306eb34e50e5dd4c239e";
    ...
    [
        ...
        new(1171, Startupˉtarget.Exitˉprocess),
        new(1215, Startupˉtarget.Dataˉarena),
        new(1231, Startupˉtarget.Nameˉarena),
        new(1298, Startupˉtarget.Dataˉarena),
        new(1356, Startupˉtarget.Fileˉinputˉscratch),
    ];
    ...
    private static uint Address(
        ...
        uint nativeˉentryˉoffset) => target switch
        {
            ...
            Startupˉtarget.Commitˉruntime => checked(startupˉaddress + 1186u),
