...
{
    internal const int BYTES = 1554;
    internal const int WVO_BYTES = 4_398;
    ...
    internal const string TEMPLATE_SHA256 =
        "59fc5462b69835f8e0ed048d90d71fc013203964d6afd49217c2f3e6c4e3193e";
    private const int LOCAL_COMMIT_RELOCATION_INDEX = 18;
    private const uint LOCAL_COMMIT_OFFSET = 1364;

    private const string TEMPLATE_BASE64 =
        "";
    ...
    [
        ...
        new(1269, Startupˉtarget.Executionˉcontext),
        new(1325, Startupˉtarget.Localˉfree),
        new(1393, Startupˉtarget.Dataˉarena),
        new(1409, Startupˉtarget.Nameˉarena),
        new(1476, Startupˉtarget.Dataˉarena),
        new(1534, Startupˉtarget.Fileˉinputˉscratch),
    ];
        ...
        uint nativeˉentryˉoffset)
    {
            ...
            !StringComparer.Ordinal.Equals(Calculateˉsha256(Unpatched), TEMPLATE_SHA256))
        {
            ...
            throw Invalid(
                Difference < 0
                    ? "The Windows hosted-compiler startup template digest is noncanonical."
                    : $"The Windows hosted-compiler startup template is noncanonical at " +
                        $"offset {Difference}.");
        }
    }
