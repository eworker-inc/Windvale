...
- Implemented bounded exact-compiler execution: measured demand of 1,480,096 record bytes justifies a 2 MiB host arena, under which the native compiler emits the exact 815-byte Stage 0 WVB while retaining ABI 20, generated bytes, execution-scoped lifetime, and independently sized Windvale OS contexts.
