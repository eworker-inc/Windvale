...
- The first Windvale-selected OS boot-resource grant candidate: init owns the fixed admitted WVB, selects resource `1` in `.wv`, and requests one checked immutable RO/NX client alias before the unchanged user-space interpreter can read it.
