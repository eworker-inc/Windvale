...
- Deterministic absolute native record-storage maps for persistent locals and block-local results, independently checked against CFG and value lifetimes and pinned for the exact compiler without changing ABI 20 or selected machine bytes.
