...
- The first Windvale OS terminal resource-borrow cleanup candidate: ordinary client exit and contained client fault both remove the WVB alias and private service/resource publication while preserving init ownership and one historical grant.
