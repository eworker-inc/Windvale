...
| 8. Self-hosted compiler | Windvale-written lexer, parser, semantics, and code generation for a meaningful subset, followed by a reproducible bootstrap closure. | Capability/profile backend qualified; multi-module, performance, and compiler closure next |
