...
| 9. Shared native backend | Native WIR/WVB lowering, x86-64 ABI, WVO/AOT output, baseline JIT, and interpreter/JIT/AOT differential tests. | Dynamic instruction budgets and backward control are cross-host qualified; shared-budget calls and static data are next |
