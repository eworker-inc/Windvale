...
| 9. Shared native backend | Native WIR/WVB lowering, x86-64 ABI, WVO/AOT output, baseline JIT, and interpreter/JIT/AOT differential tests. | ABI 6 versioned context and the first authorized static-text console service are cross-host qualified at `2fcf531`; bytes/file services are next |
