...
| 9. Shared native backend | Native WIR/WVB lowering, x86-64 ABI, WVO/AOT output, baseline JIT, and interpreter/JIT/AOT differential tests. | ABI 5 calls, budgets, recursion, and immutable i32 data are cross-host qualified; first OS AOT consumer is qualified at `708242e`; runtime services are next |
