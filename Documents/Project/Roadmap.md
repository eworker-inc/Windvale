...
| 9. Shared native backend | Native WIR/WVB lowering, x86-64 ABI, WVO/AOT output, baseline JIT, and interpreter/JIT/AOT differential tests. | Arithmetic/traps, typed blocks, comparisons, Boolean operations, and forward control flow are cross-host qualified; execution-budgeted backward control is next |
