...
| 9. Shared native backend | Native WIR/WVB lowering, x86-64 ABI, WVO/AOT output, baseline JIT, and interpreter/JIT/AOT differential tests. | First general verified-WVB constant slice is cross-host qualified through shared WVO/AOT and W^X JIT sinks; broader operations next |
