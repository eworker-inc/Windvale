...
| 9. Shared native backend | Native WIR/WVB lowering, x86-64 ABI, WVO/AOT output, baseline JIT, and interpreter/JIT/AOT differential tests. | Constants, checked straight-line i32 arithmetic, and recoverable overflow traps are cross-host qualified; comparisons and structured control flow are next |
