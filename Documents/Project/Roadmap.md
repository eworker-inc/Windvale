...
| 9. Shared native backend | Native WIR/WVB lowering, x86-64 ABI, WVO/AOT output, baseline JIT, and interpreter/JIT/AOT differential tests. | Shared-budget calls, bounded recursion, and immutable i32 data are cross-host qualified; first native Windvale tool adoption is next |
