...
| 6G. Windvale linker | A Windvale-written verified-bytecode linker implementing the accepted contract. | WVB 1.6 SHA-256 identity and deterministic bounded file snapshots are qualified at `348c82a`; Windows and Debian must next produce identical images and maps from identical verified objects, and oracle/Windvale results must agree. |
