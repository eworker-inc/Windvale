...
| 9. Shared native backend | Native WIR/WVB lowering, x86-64 ABI, WVO/AOT output, baseline JIT, and interpreter/JIT/AOT differential tests. | ABI 7 borrowed immutable bytes plus `u8`/`u32` operations are cross-host qualified at `8d375bf`; narrow file/argument input and a real tool are next |
