...
| 9. Shared native backend | Native WIR/WVB lowering, x86-64 ABI, WVO/AOT output, baseline JIT, and interpreter/JIT/AOT differential tests. | Forward control is cross-host qualified; dynamic instruction budgets and backward control pass on Windows and await Debian qualification |
