...
| 9. Shared native backend | Native WIR/WVB lowering, x86-64 ABI, WVO/AOT output, baseline JIT, and interpreter/JIT/AOT differential tests. | Shared-budget calls, bounded recursion, and immutable i32 data are implemented on Windows; Debian qualification is next |
