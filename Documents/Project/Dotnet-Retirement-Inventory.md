...
are explicit recovery commands. `Verify-Changed.ps1` adds one indirect normal
call into the managed Seed verifier. The remaining retirement work is therefore
verification gap closure and orchestration cutover, not a line-for-line rewrite
of the managed harness.
