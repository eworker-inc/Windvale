...
| T1 | Fixed native scalar tests | `native-candidate` | `Tools/Native/Test-Seed.cmd` and `.sh` run the first two-case digest-bound plan. Broader native fixture orchestration and malformed-input coverage remain. |
