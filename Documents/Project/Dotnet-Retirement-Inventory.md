...
cross-target Linux package lane. Independent Linux execution, dual-host
...
route remains pending the current native-compiler closure repin and final gate.
...
reconstructs the current hosted-container toolset. Linux execution, dual-host
promotion, native reconstruction of the seed PE/ELF, remaining accepted-tool
reconstruction, and a later release's use of this candidate as its previous seed
remain before C1 is complete.
