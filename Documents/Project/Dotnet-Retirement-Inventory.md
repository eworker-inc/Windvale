...
| N1 | Accepted-subset WVB to WVO lowering | `native-candidate` | The current Windvale lowerer handles the bounded return-42 profile and composes through link/package/execute. It is not the complete backend. |
