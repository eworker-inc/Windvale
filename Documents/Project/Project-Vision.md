...
The accepted first boot environment is x86-64 with UEFI 2.11, QEMU as the primary automated VM, and Hyper-V Generation 2 as the later Windows compatibility target. [Decisions 0044](../Decisions/0044-First-X64-Uefi-Boot-Environment.md) through [0056](../Decisions/0056-Windvale-Owned-Post-Memory-Evidence.md) establish the environment, deterministic PE32+ boundary, firmware exit, kernel handoff, owned memory and stack, and Windvale-authored post-memory evidence. [Decision 0064](../Decisions/0064-First-Shared-Native-Wvb-In-Windvale-Os.md) begins the shared WVB-derived AOT path, and [Decision 0081](../Decisions/0081-First-Terminal-X64-Cpu-Exception-Boundary.md) qualifies probe 17's terminal vector-6 invalid-opcode boundary. Candidate [Decisions 0085](../Decisions/0085-First-Wva-Owned-Q35-Clean-Shutdown.md), [0086](../Decisions/0086-First-Wva-Owned-Normalized-X64-Trap-Entries.md), and [0088](../Decisions/0088-First-Kernel-Owned-X64-Page-Tables.md) add WVA-owned clean shutdown, normalized vector-6/vector-13 entries, and the first kernel-owned W^X page-table root. This is substantial vertical source-to-machine evidence, not yet an in-guest WVB loader/verifier, process isolation, a general trap system, or a functioning kernel runtime.
