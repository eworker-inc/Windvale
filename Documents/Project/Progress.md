...
| 9. Shared native backend | 🎯 Current transfer | Qualified Decision 0117 bounds record storage at a 1,489-cell worst exact-compiler frame. Implemented Decision 0118 publishes deterministic local/result offsets and independently proves every live range; cross-host qualification is pending. | Consume the offsets in selection, independently decode the first frame-owned record ABI, then prove native Stage 1/Stage 2 equality. |
