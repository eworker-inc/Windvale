...
The latest Phase 10 local increment is [Decision 0448](../Decisions/0448-Native-Probe-40-Exception-Object-Producer.md), which adds verified WVO construction, moves the x64 exception installer object to a focused Windvale-native producer, and adds three permanent cases. The retirement coordinator now owns 28 suites and 3,130 cases. Earlier transferred families remain indexed by their decisions and the native retirement-suite specification. Internal `WVL1011`, hostile unsafe-bytecode value limits, large-native segmented-object transfer, broader native host-container reconstruction, additional dynamic WVA vectors, complete Windows/Linux execution, promotion, and the grouped retirement gate remain.
...
owns 28 suites and 3,130 fixed cases without .NET. The latest three cases verify
exact x64 exception-object construction, independent admission, and destination
preservation; the Probe 40 cases preserve
