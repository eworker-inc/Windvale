...
| 9. Shared native backend | 🎯 Current transfer | Qualified Decision 0115 shows the complete compiler inventory creates at least 77,821,091 record fields—more than 1.24 GB in ABI 20's monotonic layout—while retaining the useful 2 MiB host bound. | Preserve nominal record shapes in native IR, derive reusable storage, and then prove native Stage 1/Stage 2 equality. |
