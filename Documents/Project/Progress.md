...
The latest Phase 10 local increments are [Decision 0330](../Decisions/0330-Manifest-Driven-Native-Retirement-Test-Suite.md), which composes fixed native commands through one direct digest-bound coordinator; [Decision 0332](../Decisions/0332-Fixed-Native-Linker-Hostile-Input-Corpus.md) and [Decision 0334](../Decisions/0334-Fixed-Native-Console-Container-Hostile-Input-Corpus.md), which freeze bounded raw linker and PE/ELF containment inputs; [Decision 0335](../Decisions/0335-Fixed-Native-Wvo-Differential-Corpus.md) and [Decision 0336](../Decisions/0336-Fixed-Native-Wva-Differential-Corpus.md), which freeze the managed WVO/WVA differential sequences; [Decision 0337](../Decisions/0337-Fixed-Native-Random-Containment-Corpus.md), which retains the exact continued 2,000-value source/WVB/WVO sequence; [Decision 0338](../Decisions/0338-Fixed-Native-Console-Container-Mutations.md), which transfers 19 canonical version-1 PE/ELF structural mutations; [Decision 0339](../Decisions/0339-Fixed-Native-Wvo-Hostile-Size.md), which contains the exact first-byte-over-4-MiB WVO through verify, inspect, link, and publish; [Decision 0340](../Decisions/0340-Windvale-Native-Hosted-Console-Admission.md), which moves format-2 hosted PE/ELF admission and 15 exact valid/mutated cases into portable Windvale and the native publisher; [Decision 0341](../Decisions/0341-Fixed-Native-Console-Segmented-Size-Rejections.md), which transfers both target maximum-plus-one boundaries to one two-snapshot read-only Windvale verifier; [Decision 0342](../Decisions/0342-Native-Segmented-Console-Application-Construction.md), which streams both maximum valid applications into bounded chunks and matches the complete Stage 0 PE/ELF identities; [Decision 0343](../Decisions/0343-Native-Console-Packager-Source-Reconstruction.md), which reconstructs both console-packager WVBs exactly through the digest-bound native Project 1 front door; [Decision 0344](../Decisions/0344-Native-Console-Packager-Wvo-Reconstruction.md), which extends those same two cases through exact native WVO reconstruction without widening the emitter arena; [Decision 0345](../Decisions/0345-Verifier-Scale-Native-Staged-Wvo-Publication.md), which adds bounded function emission, closes the native multi-iteration publication bug, and lowers, publishes, verifies, and exactly reconstructs the real 1,049,615-byte verifier WVO on Windows; [Decision 0429](../Decisions/0429-Fixed-Native-Assembler-Golden-Objects.md), which transfers three exact positive assembler products; [Decision 0430](../Decisions/0430-Fixed-Native-Typed-Wvb-Rejections.md), which transfers six fixed typed-control and nominal-shape rejections; [Decision 0431](../Decisions/0431-Compact-Native-Wvb-Rejection-Closure.md), which closes four more compact stack, receiver, and nominal-kind cases; [Decision 0432](../Decisions/0432-Fixed-Native-Scalar-X64-Golden-Object.md), which transfers the compact managed positive scalar/SIB assembler source; [Decision 0433](../Decisions/0433-Fixed-Native-Wva-Positive-Matrix.md), which transfers 17 typed byte/word positive WVA vectors; [Decision 0434](../Decisions/0434-Expanded-Native-Wva-Positive-Matrix.md), which transfers 52 expanded register/control/relocation vectors; [Decision 0438](../Decisions/0438-Retained-Native-Uefi-Packager-Containers.md), which adds three native UEFI packaging cases; and [Decision 0445](../Decisions/0445-Digest-Bound-Native-Probe-40-Object-Seed.md), which adds two native Probe 40 construction and output-preservation cases. The focused publisher regression crosses the 8,192-byte I/O boundary, and the retirement coordinator now owns 26 suites and 3,123 cases. Internal `WVL1011`, hostile unsafe-bytecode value limits, large-native segmented-object transfer, broader native host-container reconstruction, additional dynamic WVA vectors, complete Windows/Linux execution, promotion, and the grouped retirement gate remain.
...
52 expanded register/control/relocation vectors. The retirement coordinator now
owns 26 suites and 3,123 fixed cases without .NET. The latest two cases preserve
the digest-bound normal Probe 40 object seed and resulting EFI image. Hostile
