...
| 10. Native host tools and .NET retirement | 🚧 In progress | Exact commit `524e84afb6e5bab6bbd95ebc0b9eeaf886af834b` cross-host qualifies the Decision 0213 WVB 1.11 semantic-freeze baseline; `9d36387867ebff80ee94c6f9f7996da4ef32a4a3` qualifies the first Decision 0214 Windows/Linux publisher profile; `d2e71c1d6491153afb715674fc13ba2c6276326a` qualifies their distributed composition as the ordinary project source-to-WVB route; and `e2d9c52548fd782a57765b1a9635d8cbe009df20` qualifies native WVB verification and deterministic inspection on both permanent hosts. Exact commit `4eae208c6f72987c1c492ab2d13754b7f2935bc8` pins the runner WVB and paired applications as a 15-artifact shared candidate inventory with explicit Stage 0 reconstruction; dual-host qualification is pending. Decision 0218 adds the first fixed native scalar test-plan candidate without copying the C# harness. Forward language semantics advance only through `Compiler/Windvale`; C# retains its recovery and independent-evidence role. | Qualify the runner and first native test plan on both hosts, then transfer additional focused fixtures and structural oracles; continue backend transfer, remaining tools, and the final recovery archive. |
