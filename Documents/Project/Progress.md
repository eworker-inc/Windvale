...
> Status: Current project snapshot as of 1 September 2026
...
| Unsafe Foundation slice | Candidate | Canonical unsafe value types, scratch construction, and immutable scratch observation are executable through WVB 1.35 with compiler-aligned scalar/native evidence. Decisions [0909](../Decisions/0909-Lower-Mutable-Unsafe-Write-Region-Borrowing-To-Wvir.md) and [0910](../Decisions/0910-Represent-Mutable-Write-Region-Borrowing-In-Candidate-Wvb-1.36.md) lower exact mutable `Borrowˉwriteˉregion` through independently checked WVIR 1.27/1.28 and deterministic candidate WVB 1.36 while execution remains closed. | Add compiler-verified WVB write-region lifetime containment, then scalar/native execution, pointer derivation, authenticated Foreign calls, a migrated real boundary, Linux reproduction, and paired-host qualification. |
