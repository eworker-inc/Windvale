...
| 9. Shared native backend | 🎯 Current transfer | Qualified Decision 0117 preserves nominal machine-IR shapes and reduces Decision 0115's more-than-1.24-GB monotonic pressure to a projected 1,489-cell worst exact-compiler frame through deterministic liveness reuse. | Publish exact storage offsets, implement and independently decode the first frame-owned record ABI, then prove native Stage 1/Stage 2 equality. |
