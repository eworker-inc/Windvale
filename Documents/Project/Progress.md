...
| 9. Shared native backend | 🎯 Current transfer | Qualified Decision 0115 identifies more than 1.24 GB of ABI-20 monotonic record pressure. Implemented Decision 0117 preserves nominal machine-IR shapes and projects the worst exact-compiler frame at 1,489 cells after deterministic liveness reuse; cross-host qualification is pending. | Publish exact storage offsets, implement and independently decode the first frame-owned record ABI, then prove native Stage 1/Stage 2 equality. |
