...
typed-control and nominal-shape rejections. The retirement coordinator now owns
24 suites and 3,044 fixed cases without .NET. Value limits, other typed opcode
families, and additional dynamic WVA vectors remain later work.
