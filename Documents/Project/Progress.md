...
| Windvale Language 1.0 | 🚧 | [Decision 0767](../Decisions/0767-Freeze-Windvale-Language-1.0-Source.md) freezes the exact replacement source design, and [migration evidence](Windvale-Language-1.0-Migration-Evidence.md) binds its bundles and fixtures. Slices 2 and 3 cover the scalar/value surface, typed failure, generic Foundation `Option`/`Result`, canonical generic syntax and resolution, and bounded generic-function specialization. Slice 4 includes generic nominal materialization, contextual fixed arrays, executable Vector/Sequence operations, owned local transfer, exact Sequence reads, Vector length/freeze, exact result contexts, and all fixed enum backing analysis. Decision 0834 starts Slice 5 with WVB 1.21 launcher-to-entry `Memoryˉbudget` transfer and deterministic release; [Decision 0835](../Decisions/0835-Represent-U8-Backed-Enums-As-Wvb-1.22.md) adds exact executable `u8`-backed enums through WVB 1.22, [Decision 0836](../Decisions/0836-Bind-Memory-Budget-Split-In-Wvir-1.5.md) binds the exact Split call as WVIR operation 171, [Decision 0837](../Decisions/0837-Execute-Memory-Budget-Split-As-Wvb-1.23.md) connects it to bounded WVB execution, verification, and runtime accounting, [Decision 0838](../Decisions/0838-Admit-Exact-Language-1.0-Effect-Clauses.md) admits bounded effect-clause syntax with retained declaration metadata, and [Decision 0839](../Decisions/0839-Admit-Exact-Language-1.0-Using-Statements.md) admits bounded `using` statement syntax and retained resource-scope spans. [Decisions 0840](../Decisions/0840-Bind-Fallible-Vector-Construction-In-Wvir.md), [0841](../Decisions/0841-Prove-Generation-Safe-Allocation-Leases.md), and [0842](../Decisions/0842-Execute-Fallible-Vector-Construction-As-Wvb-1.24.md) bind operation 172, prove generation-safe lease transfer, and execute exact fallible Vector construction through canonical WVB 1.24 with typed refusal and descriptor-owned release. [Decisions 0843](../Decisions/0843-Execute-Recoverable-Vector-Append-As-Wvb-1.25.md), [0844](../Decisions/0844-Prove-Owned-Vector-Calls-And-Forward-Joins-In-Wvir.md), and [0845](../Decisions/0845-Execute-Owned-Vector-Calls-As-Wvb-1.26.md) add recoverable append, prove exact Vector calls/joins, and execute them with signature-encoded modes and reverse-slot callee cleanup. [Decision 0846](../Decisions/0846-Compact-Wvir-Operation-Records.md) restores compiler capacity with 28-byte WVIR 1.9–1.14 operation records under the unchanged 4 MiB ceiling, [Decision 0847](../Decisions/0847-Lower-Semantic-Using-And-Prove-Loop-Ownership.md) lowers exact-Vector `using`, reverse nested cleanup, and exact loop ownership fixed points, [Decision 0848](../Decisions/0848-Execute-Transactional-Vector-Growth-As-Wvb-1.27.md) executes explicit reserved Vector growth as a strong transaction through WVB 1.27, and [Decision 0850](../Decisions/0850-Own-Vector-Containing-Aggregates-As-Wvb-1.28.md) recursively moves and deterministically releases Vector-containing aggregates through WVB 1.28. [Decision 0851](../Decisions/0851-Transfer-A-Rights-Limited-Source-File-As-Wvb-1.29.md) completes Slice 5 with an exact move-only source snapshot, WVB 1.29 verifier confinement, generation-safe launcher transfer, and deterministic `using` release. [Decisions 0852](../Decisions/0852-Represent-Exact-Structural-Function-Types-With-Wvft.md) through [0856](../Decisions/0856-Execute-Noncapturing-Callable-Values-As-Wvb-1.30.md) begin Slice 6 with exact structural types, captures, transitive effects, concrete callable cataloging, and verified executable noncapturing callable values through WVB 1.30. The 478-case Language front door remains the broad gate; focused 29-case accounting, combined 113-case Split/Vector/aggregate/`using`/resource execution, 38-case callable, 20-case effect-clause, and 18-case `using` syntax owners preserve shorter inner loops. [Decision 0810](../Decisions/0810-Use-The-Split-Compiler-For-Compiler-Scale-Development.md) keeps immutable Seed recovery provenance while the evolving analyzer/emitter becomes the Windvale 1.0 compiler. | Continue Slice 6 with closure-environment lowering, captured move/borrow lifetime and escape enforcement, effectful callable values, and the selected native callable ABI. Keep provider-backed budget-authority expansion explicit and separate. Defer broad transitional-compiler optimization until self-hosting while still fixing measured blockers, packaging cost, and verification waste. |
