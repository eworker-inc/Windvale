...
| Unsafe Foundation slice | Candidate | Canonical unsafe value types and `Constructˉscratch` lower to typed WVIR with explicit memory authority, size, alignment, ABI, effect, and failure shape under Decisions [0898](../Decisions/0898-Publish-Canonical-Foundation-Unsafe-Type-Identities.md), [0899](../Decisions/0899-Lower-Canonical-Unsafe-Scratch-Construction-To-Wvir.md), and [0901](../Decisions/0901-Advance-The-Frozen-Source-Identity-For-Unsafe-Scratch.md). | Add WVB representation and verifier, runtime, and native containment. The operation intentionally remains non-executable today. |
...
- The evolving Language 1.0 compiler uses later versioned WVB contracts, with
  the current structured-task slice at WVB 1.32.
