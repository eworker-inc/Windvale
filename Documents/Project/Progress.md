...
block driver, and live file data reads remain pending. Short-directory admission now
...
has 80 cases. Chain-result binding, block dispatch, partial-sector copying, and
filesystem reply construction remain open. VFAT long-name/Unicode mapping
