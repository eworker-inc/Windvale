...
| 10. Native host tools and .NET retirement | 🚧 In progress | Exact commit `524e84afb6e5bab6bbd95ebc0b9eeaf886af834b` cross-host qualifies the Decision 0213 WVB 1.11 semantic-freeze baseline; `9d36387867ebff80ee94c6f9f7996da4ef32a4a3` qualifies the first Decision 0214 Windows/Linux publisher profile; and `d2e71c1d6491153afb715674fc13ba2c6276326a` qualifies their distributed composition as the ordinary project source-to-WVB route on both permanent hosts. The inventory pins six native/WVB artifacts with explicit Stage 0 reconstruction. Forward language semantics advance only through `Compiler/Windvale`; C# retains its recovery and independent-evidence role. The extended publisher fault/concurrency matrix remains hardening work. | Select the next coherent normal-path Stage 0 responsibility—native WVB inspection/execution or native test orchestration—while continuing backend transfer, publisher hardening, remaining tools, and the final recovery archive. |
