...
| Windvale Language 1.0 | 🎯 | [Decision 0767](../Decisions/0767-Freeze-Windvale-Language-1.0-Source.md) freezes the exact replacement source design after Decisions 0751–0766 and all sixteen paper workloads. The 3,702-byte [replacement manifest](Windvale-Language-1.0-Replacement-Source-Freeze-Candidate.txt) records 250 inputs totaling 1,724,854 bytes, manifest SHA-256 `c9517841eae6b6e86778cb1dd88711feb38929dec8fe79e084eec44fa22c512a`, and aggregate SHA-256 `fb918a763ae7c8c85dd1a2ffecee6587ab93bbf846ae31ae19b53509aed36a0a`. This freezes design only: Seed remains implemented, and `zh-Hans@1` remains draft pending native and executable qualification. | Execute Migration Slice 0, then implement the bounded edition/profile front door in the existing compiler and preserve Seed until each named migration gate passes. |
