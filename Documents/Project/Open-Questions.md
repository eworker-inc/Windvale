...
4. Generalize exactly one runtime boundary after qualified probe 25: carry a bounded boot-resource/module input into the section-derived interpreter, or add a third runnable only when it creates real scheduler pressure. Keep JIT publication, broader traps, virtual memory, and lifecycle adapters separate.
