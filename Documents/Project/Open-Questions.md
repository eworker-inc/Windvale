...
- Cross-host-qualified Probe 38 implements Decision 0173's fixed third directory-service process, separate resource and directory endpoints, and smallest ready/wait dispatcher. Which process/thread states, cursor rules, wake causes, counters, and malformed-state checks should survive the first timer-preemption slice before becoming a more general run-queue contract?
