...
- Decision 0172 implements one kernel-owned generation-safe service endpoint over the shared format-blind channel. Which independently lived second service, third runnable, concurrent call, or provider replacement should first justify endpoint names, a registry, dynamic publication, and broader discovery rather than premature generalization?
