...
1. Measure exact compiler immutable-record allocation after Decision 0111 reaches deterministic `WVR3017`, then compare a bounded larger region, phase/region lifetime, and reclamation without weakening descriptor validity.
...
3. Complete native compiler execution and byte-compare its output with Stage 0 before adding native PE/COFF and ELF containers plus standalone Windows/Linux capability and process hosts.
