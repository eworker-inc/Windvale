...
The verifier performs a Release build, runs the 34-test conformance suite, produces a Windows report, publishes the CLI as framework-dependent `linux-x64`, and exercises the real module, Windvale/Stage 0 assembly, Windvale WVO scan and candidate-image construction, object, and Stage 0 link CLI paths. It checks capability refusal, deterministic file snapshots, SHA-256 sequence/slice behavior, byte-for-byte assembler equality, exact candidate-image identity, independent WVO and Stage 0 flat-image verification, exact map output, no file for rejected source/link or a missing parent, and preservation of existing object/image outputs when validation fails. The image/relocation-qualified WVB 1.6 Windows report SHA-256 is `57a0d301e64e76431d964e1cd34dd3be1fb04f9a67d666ffc522d41d91c69859`.
