...
| Windvale-written inspection | `Wvˉdumpˉcore` walks the canonical six-section envelope, returns distinct statuses for malformed classes, rejects a hostile maximum payload length without overflow or a bounds trap, and embeds a minimal module independently accepted by the reference verifier. |
...
- `Wv-Dump-Core.wvb`: `c3670bb769168711d61f98845ff503abec2cb48dedfffcb0c5f76a1b6e039b62`, result `0`.
