...
The experiment is published as a static GitHub Pages project site at <https://eworker-inc.github.io/Windvale/>. GitHub serves application files; compilation, verification, and execution remain inside the user's browser.
