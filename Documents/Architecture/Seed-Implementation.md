...
WIR uses virtual temporaries and local slots. The Stage 0 C# compiler lowers its typed WIR to bytecode, and the portable Windvale-written front end publishes the separate WVIR 1 contract. The Windvale-written backend assigns every WIR temporary a bytecode local and emits a complete WVB 1.6 module for one portable, hosted, or system module with primitive functions, static data, immutable records, nominal enums, explicit catalog capabilities, text/bytes, and Foundation intrinsics. WVIR retains stable WVSD declaration identities; the backend translates them to ordinal WVB function, data, and capability indices, uses canonical nominal identities as Types indices, and emits canonical functions, exports, types, capabilities, explicit data, and interned text literals. The operand stack stays empty between WIR operations and at block boundaries. This intentionally verbose form remains easy to inspect, verify, and compare byte for byte with Stage 0. Imports and multi-module translation remain explicit later slices.
...
- `Compilerˉsourceˉset`: `c03b3e9daa5b20fc2f77a0d1dd15cb1fdc1728e2a6eda021aa766b19b1bfa2b8`
- `Compilerˉsourceˉsetˉdemo`: `0054138c6e39f3c99e5cd4751c796cd599b495880d7db174323342fb7b687488`
- `Compilerˉsourceˉsetˉtool`: `dc290826985f66f80d469b99235ca290dc617997edee0aab2ea0d4227984aab6`
- `Compilerˉsourceˉgraph`: `1617419c838effd80e4ab3f167912f47f4959002a77b0b166970b1d8f30f3133`
- `Compilerˉsourceˉgraphˉdemo`: `53c976f867dccf60bf26aa74e3942cf877b048405f57dd42e462dbe0b63c9073`
- `Compilerˉsourceˉgraphˉtool`: `75fdf22e93f154599cdf4530ebcf828eec061458c73f6ab09b00d0765e3ebdc1`
- `Compilerˉsourceˉsymbols`: `79a60d3734c8c128af327b3c9e015bfa1f5b2c9d7b87abf4fb3fc2428d8bac3a`
- `Compilerˉsourceˉsymbolsˉdemo`: `476551cc0990588c3e782f45be83baebbcf3cd519cc0fe8dc17ccd67a7aa3714`
- `Compilerˉsourceˉsymbolsˉtool`: `852dae1fe1962351e46a70e70bbdd4547814de17d75a8409e56aa0f94ccd7a4d`
