...
8. 🎯 Add the signed official repository and connected installer selected for Milestone 5, while preserving byte-identical offline admission and recovery.
9. 🎯 Add portable service declarations and explicit Windows/Debian lifecycle integration for the database and model-gateway packages selected for Milestone 5.
