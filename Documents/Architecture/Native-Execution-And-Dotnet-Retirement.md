...
Accepted architectural direction under [Decision 0057](../Decisions/0057-Windvale-Native-Execution-And-Dotnet-Retirement.md). Decision 0058 qualifies bytecode compiler self-reproduction. Decisions 0059 through 0068 cross-host qualify the shared Stage 0 and first OS consumer seams through ABI 9. [Decision 0069](../Decisions/0069-Dynamic-Native-Text-And-Complete-Wvdump.md) through [Decision 0074](../Decisions/0074-Native-Windows-And-Linux-Output-Services.md) cross-host qualify ABI 10 through ABI 13, the complete native `wvdump`, all six deterministic pure native-service leaves, exact immutable argument services, direct Windows/Linux output, and firmware probe 15. This document defines the larger native destination and migration boundaries; it does not claim an in-guest WVB loader, a general native runtime, broad JIT or AOT compiler, PE host, ELF host, garbage collector, or native self-hosting chain.
