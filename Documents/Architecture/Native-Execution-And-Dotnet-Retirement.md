...
Decisions 0280 through 0284 advance the large native-object seam without
...
reproduce the independent Stage 0 object byte for byte. They deliberately do
not reuse the pre-opened random-access-storage capability, whose contract
...
adapter must bind and validate the exact staged resources, reconstruct and
verify the WVO, then supply unique-sibling creation, partial and indeterminate
