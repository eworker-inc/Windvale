...
- Extends: [Decision 0076](0076-Native-Windows-And-Linux-File-Input.md)'s runtime-private host-file pattern and [Decisions 0085](0085-First-Wva-Owned-Q35-Clean-Shutdown.md) and [0086](0086-First-Wva-Owned-Normalized-X64-Trap-Entries.md)'s OS candidate
...
The implementation also advances the Windvale publication planner to the closed 12-service domain. Its current portable core remains 7,189 bytes with SHA-256 `b25fa550518caa4ef43c7ae886cce328148777782f70e3faa25ac19821b6d439`; the regenerated 7,105-byte retained bridge has SHA-256 `750b6134395c46c9e1c703ae2a56449bd1710f517e516397e10a1ccc951c503e`. Firmware probe 20 composes the ABI rebuild with Decisions 0085 and 0086's WVA-owned clean-shutdown and normalized-trap paths. Focused reconstruction fixes its preliminary 20,992-byte images at SHA-256 `d4a9e3625779dd3ef2a03fd71ecfe1502c1ad39378da7adbcf7e4b55636eed8c` for normal, `705670b1054589b80e3c918c03e9f751304e3f4b5bda77485f606433db68a757` for invalid opcode, and `df45d8e0f69581e5ed3b46608598e6170413f80c5c1bbba9233e9842cdd7a04d` for general protection. All three pass pinned QEMU locally; those identities become qualification evidence only after exact committed-archive execution.
