...
- Date: 2026-08-02
- Status: Implemented and deployed with deterministic-engine, Chromium browser, and cross-host repository evidence; retained route advanced to ABI 2 by [Decision 0113](0113-Metered-WebAssembly-Control-Flow.md); cross-browser qualification pending
