...
This is candidate evidence only. Windows/Debian archive identity, normalized reports, complete portable artifacts, full Seed qualification, and independent GitHub verification require a later qualification record before cross-host status changes.
