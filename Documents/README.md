...
- [Windvale shell product and architecture](Architecture/Windvale-Shell.md) — proposed portable shell experience, concise command model, discovery, aliases, host adapters, Workbench transition, and staged delivery
