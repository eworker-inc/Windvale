...
- [Windvale Shell 1 contract proposal](Project/Windvale-Shell-1-Proposal.md) — proposed exact one-token grammar, quoting, limits, aliases, parser diagnostics, first catalog, and promotion gate
