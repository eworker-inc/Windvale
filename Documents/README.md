...
- [WebAssembly playground exploration](Project/WebAssembly-Playground-Exploration.md) — implemented Stage 0 host plus Windvale-authored constant and checked-add direct-backend slices, possible permanent browser target, constraints, and remaining decisions
