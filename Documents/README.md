...
- [Stage 0 semantic freeze and native front door](Decisions/0213-Stage0-Semantic-Freeze-And-Native-Front-Door.md) — accepted migration policy that freezes forward C# source semantics at the next qualified WVB 1.11 baseline and moves ordinary source-to-verified-WVB work to native tools first
