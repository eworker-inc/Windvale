...
- [First native external-model gateway bridge](Decisions/0646-First-Native-External-Model-Gateway-Bridge.md) — supervised model-only native worker, dual-host pipe leaves, explicit timer ownership, and canonical ABI-23 gateway composition
