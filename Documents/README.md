...
- [Fixed native WVA assembler rejection families](Decisions/0318-Fixed-Native-Wva-Assembler-Rejection-Families.md) — one exact output-preserving case for every stable WVA diagnostic family
