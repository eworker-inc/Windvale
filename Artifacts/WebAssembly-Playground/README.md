...
[Decision 0421](../../Documents/Decisions/0421-Import-Free-Browser-Console-Envelope.md) owns the interpreter's import-free `WVXI 3` grant and bounded-output boundary. It requires no browser extension or .NET runtime.
