...
The current package includes [Decision 0292](../../Documents/Decisions/0292-Bounded-Direct-WebAssembly-Static-Descriptors.md)'s bounded immutable text/bytes lowering, [Decision 0296](../../Documents/Decisions/0296-Bounded-Direct-WebAssembly-Nominal-Tables.md)'s complete bounded nominal-table validation, [Decision 0297](../../Documents/Decisions/0297-Compiler-Scale-WebAssembly-Function-Inventory.md)'s compiler-scale function-directory admission, and [Decision 0298](../../Documents/Decisions/0298-Compiler-Scale-WebAssembly-Code-Inventory.md)'s bounded instruction and direct-call inventory. Inputs without static payload retain their previous WebAssembly identity, and unused nominal declarations do not change emitted bytes. The exact browser compiler now clears its declarations, 417-function directory, 157,844 instruction widths, and 2,991 call targets; typed signatures, control-flow proof, nominal values, and direct operation emission remain open.
